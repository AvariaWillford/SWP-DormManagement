...
function handleToggleSidebarOn() {
    document.getElementById("sidebar-full").style.width = "320px";
    document.getElementById("content-body").style.marginLeft = "320px";
}
function handleToggleSidebarOff() {
    document.getElementById("sidebar-full").style.width = "0";
